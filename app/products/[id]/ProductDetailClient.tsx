...
export default function ProductDetailClient({ initialProduct, id }: ProductDetailClientProps) {
  ...
  function handleAddToCart() {
    ...
    if (result === "conflict") {
      toast.error("Your cart has items from another seller. Start a new cart to add this item.");
    } else {
      ...
      <div className="grid md:grid-cols-2 gap-10 lg:gap-16">
        ...
        <div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 mb-3">
            ...
            <Button variant="outline" size="lg" onClick={handleBuyNow} disabled={product.stock === 0}>Buy Now</Button>
